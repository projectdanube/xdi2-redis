...
<body>
	...
	<div id="main">
	<div class="header">
	<span id="appname">xdi2-redis</span>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<% for (int i=0; i<((Integer) request.getAttribute("sampleInputs")).intValue(); i++) { %>
		<a href="XDIRedis?sample=<%= i+1 %>">Sample <%= i+1 %></a>&nbsp;&nbsp;
	<% } %>
	</div>
	...
	<form action="XDIRedis" method="post" accept-charset="UTF-8">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;<a href="XDIRedisHelp.jsp">What can I do here?</a>
